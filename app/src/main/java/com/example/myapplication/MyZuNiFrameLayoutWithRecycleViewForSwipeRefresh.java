...
/**
 * Scroller恢复+阻尼滑动+SwipeRefreshLayout下拉刷新(RecycleView冲突解决)
 */
public class MyZuNiFrameLayoutWithRecycleViewForSwipeRefresh extends MyZuNiFrameLayout {
    float downY;
    ...
    public MyZuNiFrameLayoutWithRecycleViewForSwipeRefresh(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
